...
Данные в бд хранятся на дисках в файлах. Быстрый доступ к данным возможен, когда у данных фикс размер. перемещаться по ним и считать смещения. Если размер данных не известен, просматривать весь файл в поисках значения. 
