...
В самом конце набора строки Visual Studio Code сам вам предложит ее преобразовать. Вам нужно только нажать Enter, когда на экране есть всплывающая подсказка. Преобразование строки в HTML
Выделить всю строку и нажать комбинацию клавиш Ctrl + Shift + P. Во всплывающем окне начать набирать >Emmet: Expand Abbreviation и выбрать этот пункт.
