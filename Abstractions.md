делить сложное на простое — на уровни абстракции.
...
принципа единой ответственности. Абстрактный класс должен отвечать только за одну область поведения. Не смешивать, например, методы для хранения и методы для бизнес-логики в одном абстрактном классе.
