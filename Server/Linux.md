Unix - ОС.
Семейство стандартов POSIX (Portable Operating System Interface for UNIX), описывает работу ключевых компонентов ОС и способов взаимодействия с ними из программ на Си.
