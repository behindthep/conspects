Java Development Kit — всё, что нужно для создания, компиляции и запуска программ:
...
нажимаете Run: IDEA компилирует код — превращает .java в .class (байт-код для JVM).
...
чтобы процессор понимал, какие команды записаны в программе, программисты создали компилятор — программу, преобразует программный код в машинный.
...
Программа на C++ -> Компилятор -> Программа, из машинных кодов
...
программа JVM - запускают ее, а затем — программу, состоящую из байт-кода. JVM перед выполнением программы компилирует ее в машинный код.
