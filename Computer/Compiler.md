...
Если вы написали программу под Android, то на ос Windows она не запустится!

Программа на языке Java -> Java‑компилятор -> Программа из специальных кодов (байт‑код) -> Java VM -> Программа, состоящая из машинных кодов
