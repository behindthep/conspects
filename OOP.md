...
цепочка наследования длиннее 3–4 уровней, задумайтесь: не пора ли использовать композицию или интерфейсы вместо наследования?

Абстрактный класс — когда есть общее состояние и/или частичная реализация. Интерфейс — когда нужно только «пообещать» наличие методов, но не хранить данные и не реализовывать поведение.
