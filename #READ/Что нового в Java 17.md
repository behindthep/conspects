...
Java 17 позволяет писать более понятный и компактный код и принёс немало полезных возможностей и ограничений.

Много JEP-нововведений (JDK Enhancement Proposal) в виртуальной машине, сборщике мусора, новых методах и уже существующих классах.
